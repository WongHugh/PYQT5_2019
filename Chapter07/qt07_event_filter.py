...
# @Time : 2019-3-15 13:47
# @Author : leoyo
# @Email : #
# @File : qt07_event_filter.py
# @Project : PYQT5_UI
# @IDE : PyCharm
...
class EventFilter(QDialog):
    def __init__(self, parent=None):
        ...
        self.image1 = QImage("images/IOTPP.png")
        self.image2 = QImage("images/IOTPP.png")
        self.image3 = QImage("images/IOTPP.png")
